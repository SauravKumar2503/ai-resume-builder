    ...
    <div>
      ...
      >
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem className="text-black hover:bg-gray-100" onClick={() => navigation(`/dashboard/resume/${resume.documentId}/edit`)}>
              Edit
            </DropdownMenuItem>
            <DropdownMenuItem className="text-black hover:bg-gray-100" onClick={() => navigation(`/my-resume/${resume.documentId}/view`)}>
              View
            </DropdownMenuItem>
            <DropdownMenuItem className="text-black hover:bg-gray-100" onClick={() => navigation(`/my-resume/${resume.documentId}/view`)}>
              Download
            </DropdownMenuItem>
            <DropdownMenuItem className="text-black hover:bg-gray-100" onClick={() => setOpenAlert(true)}>
              Delete
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
